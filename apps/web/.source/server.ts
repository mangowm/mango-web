...
import * as __fd_glob_17 from "../content/docs/appearance/theming.mdx?collection=docs"
import * as __fd_glob_16 from "../content/docs/appearance/effects.mdx?collection=docs"
import * as __fd_glob_15 from "../content/docs/appearance/animations.mdx?collection=docs"
import * as __fd_glob_14 from "../content/docs/bindings/mouse-gestures.mdx?collection=docs"
import * as __fd_glob_13 from "../content/docs/bindings/keys.mdx?collection=docs"
...
import { default as __fd_glob_3 } from "../content/docs/appearance/meta.json?collection=docs"
...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, "advanced/meta.json": __fd_glob_1, "bindings/meta.json": __fd_glob_2, "appearance/meta.json": __fd_glob_3, "configuration/meta.json": __fd_glob_4, "window-management/meta.json": __fd_glob_5, }, {"faq.mdx": __fd_glob_6, "index.mdx": __fd_glob_7, "installation.mdx": __fd_glob_8, "quick-start.mdx": __fd_glob_9, "advanced/integrations.mdx": __fd_glob_10, "advanced/ipc.mdx": __fd_glob_11, "advanced/waybar.mdx": __fd_glob_12, "bindings/keys.mdx": __fd_glob_13, "bindings/mouse-gestures.mdx": __fd_glob_14, "appearance/animations.mdx": __fd_glob_15, "appearance/effects.mdx": __fd_glob_16, "appearance/theming.mdx": __fd_glob_17, "configuration/basics.mdx": __fd_glob_18, "configuration/input.mdx": __fd_glob_19, "configuration/monitors.mdx": __fd_glob_20, "window-management/layouts.mdx": __fd_glob_21, "window-management/overview.mdx": __fd_glob_22, "window-management/rules.mdx": __fd_glob_23, "window-management/scratchpad.mdx": __fd_glob_24, });