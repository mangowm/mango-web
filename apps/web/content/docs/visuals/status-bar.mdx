...
<Callout type="tip">
You can also use the `dwl/tags` module, but `ext/workspaces` provides better integration with MangoWM's features.
</Callout>
...
<Callout type="tip">
You can find a complete Waybar configuration for MangoWM at [waybar-config](https://github.com/DreamMaoMao/waybar-config).
</Callout>
